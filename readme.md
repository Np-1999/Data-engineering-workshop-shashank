...
- [ ] Find the smallest window in a string containing all the characters of the second s - tring
...
- [ ] Delete linked list
- [ ] Reverse linked list
- [ ] Detect loop in a linked list - McKinsey
...
- [ ] Find if there is a path b/w two vertices in a directed graph
...
- [ ] 100 prisoners, red and blue hats
- [ ] Measure weight of an elephant
- [ ] Measure 9 minutes
- [ ] Shortest path in cube
- [ ] Angle b/w hour and minute hand
- [ ] 100 doors puzzle
- [ ] Biased to unbiased coin
- [ ] Red blue pills
- [ ] 25 horses puzzle
- [ ] Poisoned bottles
- [ ] Find the lightest coin
- [ ] Snail and well problem
- [ ] Prisoner hat riddle
- [ ] Cut the cake
- [ ] 3 bulbs and switches problem -> Koo (Indian Twitter)
- [ ] Ask the question
- [ ] Cheating husbands
- [ ] 12 marbles and a scale
- [ ] Socks puzzle
- [ ] Bee and train puzzle
- [ ] Will you die
- [ ] Globe walker
- [ ] Crossing the river
- [ ] Changing your mind
- [ ] Divide cards symmetrically
- [ ] Where are you
- [ ] Real and fake coins
- [ ] Camel and banana puzzle
- [ ] Probability of observing a car
- [ ] Red and blue marbles
- [ ] Warden and 23 prisoners
- [ ] Crossing a bridge
- [ ] Age of daughter
- [ ] Trains and birds
- [ ] Inverted cards puzzle
- [ ] Aligned clock hands
- [ ] 3 blind men hat color
- [ ] Gold bar problem
- [ ] 5 pirates 100 coins
